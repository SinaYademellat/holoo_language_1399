...
def t_keyword(t):
    ...
    r'(break)|(case)|(continue)|(default)|(else)|(function)|(for)|(input)|(output)|(return)|(sizeof)|(switch)'
    return t
...
def p_cond_stmt_if(t):
    ''' cond_stmt : if  O_Parenthesis expr C_Parenthesis '''
   
    t[0]='p_cond_stmt_if'

def p_cond_stmt_if_els(t):
    '''cond_stmt : if  O_Parenthesis expr C_Parenthesis block else block'''
    t[0]='p_cond_stmt_if_els'
...
# statementH --> return;  <expr>; break; continue; sizeof(<type>)
